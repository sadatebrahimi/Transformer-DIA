...
logger = logging.getLogger("transformer_dia")
...
def predict(
    ...
    """
    Predict peptide sequences with a trained Transformer-DIA model.
...
def evaluate(
    ...
    """
    Evaluate peptide sequence predictions from a trained Transformer-DIA model.
...
def _execute_existing(
    ...
    """
    Predict peptide sequences with a trained Transformer-DIA model with/without
    evaluation.
